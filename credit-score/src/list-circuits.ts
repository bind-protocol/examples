...
async function main() {
  ...
  // Note: Circuit ID uses underscores (credit_score) to match the policy's proving.circuitId
  const targetCircuitId = process.env.CIRCUIT_ID || "bind.demo.credit_score.v0_1_0";
